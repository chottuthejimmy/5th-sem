<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">Whether you're in the market for a cozy bungalow, a spacious family home, or a luxurious condominium, our team of dedicated professionals is here to guide you through every step of the process. With years of experience and a deep understanding of the market dynamics, we offer tailored solutions to meet your unique needs and preferences.</p>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Developed By Ritik and Tarun under the guidance of Komala Mam</span> </div>
                    <div class="col-sm-6">
