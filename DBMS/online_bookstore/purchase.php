					...
					<div class="container-fluid">
						<form method="post" action="process.php" class="form-horizontal">
							...
							<div class="form-group mb-3">
								...
								<input type="text" class="form-control rounded-0" name="card_number" required = "true">
							</div>
							<div class="form-group mb-3">
								<label for="card_PID" class="control-label">CVV</label>
								<input type="text" class="form-control rounded-0" name="card_PID" required = "true">
							</div>
							<div class="form-group mb-3">
								<label for="card_expire" class="control-label">Expiry Date</label>
								<input type="text" class="form-control rounded-0" name="card_expire" pattern="(0[1-9]|1[0-2])\/?([0-9]{4}|[0-9]{2})$" placeholder="MM-YY" required oninput="this.value = this.value.replace(/(\d{2})(\d)/, '$1/$2')">
							</div>
							<div class="form-group mb-3">
								<label for="card_owner" class="control-label">Name</label>
								<input type="text" class="form-control rounded-0" name="card_owner" required = "true">
							</div>
							<div class="form-group mb-3">
